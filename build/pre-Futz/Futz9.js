...
function stadSpeed() {
    let stadSpeed = `{"name" : "speed𝒙3 ${botVersion} ${speedvelocity}",
...
function stadDark() {
    let stadDark = `{"name" : "dark𝒙3 ${botVersion} ${speedvelocity}",
...
room.onPlayerTeamChange = function (changedPlayer, byPlayer) {
    ...
    if (afklist.includes(changedPlayer.id)) {afkNEXTplayer();return;}
    if (changedPlayer.team == Team.SPECTATORS) {updateList(Math.max(teamR.findIndex((p) => p.id == changedPlayer.id), teamB.findIndex((p) => p.id == changedPlayer.id), teamS.findIndex((p) => p.id == changedPlayer.id)), changedPlayer.team);}
    updateTeams();
    checkTeamSizeLimit();
};
...
room.onPlayerChat = function (player, message) {
    ...
    if (["speed", "mapa1"].includes(message[0].toLowerCase())) {
        if (choose === true) {
            ...
            if (player.id === teamS[0].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[1].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[2].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[3].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[4].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[5].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[6].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[7].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[8].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[9].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[10].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[11].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[12].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[13].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[14].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[15].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[16].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[17].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[18].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[19].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
            if (player.id === teamS[20].id) {
                room.sendAnnouncement(centerText("Só quem vai jogar que vota, meu mano " + player.name), player.id, yellow, "normal");
            }
        }
    }
